...
## 📋 구현 기능 목록
- [x] 1.문자열 입력 후 입력 데이터 저장 & 구분자와 사용 변수 선언
- [x] 2. 구분자 분리 1 : 쉼표(,)와 클론(:) 파악 조건문
- [x] 3. 구분자 분리 2. : 커스텀 구분자(//구분자\n) 파악 조건문
- [x] 4. 예외 처리 1 : 빈 문자열 입력시 출력값
- [x] 5. 예외 처리 2 : 숫자로만 구성된 문자열 입력시 처리
- [x] 6. 예외 처리 3 : 잘못된 숫자나 음수 예외 처리
- [x] 7. 분리하여 얻은 숫자의 합 구하기
- [x] 8. 결과 출력
------------------------------------
## 🚨 과제 진행 요구 사항
