...
- [ ] 숫자와 지정된 구분자로만 이루어진 문자인지 판별한다.
  - [ ] 기본 구분자가 아니면서 커스텀 구분자가 아닌 구분자가 포함되면, 올바른 문자열이 아니다.
  - [ ] 기본 구분자만 포함되면, 올바른 문자열이다.
  - [ ] 커스텀 구분자만 포함되면, 올바른 문자열이다.
  - [ ] 기본 구분자와 커스텀 구분자만 포함되면, 올바른 문자열이다.
