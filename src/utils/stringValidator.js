...
const validateMaxLength = (line) => {
  if (line.length > MAX_LENGTH) throw new Error('[ERROR] 최대 글자 제한인 15자를 초과하였습니다.');
}
...
export const validateLinePart = (str, separators) => {
