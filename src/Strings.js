...
const ErrorMessages = {
  ...
  CALCULATOR_CHECK_IS_POSITIVENUMBER: ERROR_PREFIX + "[ERROR] 양수가 아닌 값은 계산할 수 없습니다."
};

export { RESULT_PREFIX, INPUT_MESSAGE, EMPTY_STRING, ErrorMessages, DELIMITER_SECTION_START, INPUT_DELIMITER, DefaultDelimiters };